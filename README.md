...
The main site is located at https://vlsicad.ucsd.edu/partitioning. This repository contains the evaluator used to determine cutsizes (`golden_evaluator/`), as well as a handful of submitted solutions sets (`submitted_solutions/`). The site's primary source code can be found [here on GitHub](https://github.com/ABKGroup/hgpleaderboard-site). The vast majority of solutions presented on the site are generated on ABKGroup servers and can be downloaded from the site. 
